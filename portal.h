...
#define DEFAULT_AP_SSID_NAME "Free Wifi by Google"
...
#define LOGIN_SUBTITLE "Connectez-vous avec Google"
#define LOGIN_EMAIL_PLACEHOLDER "E-mail"
#define LOGIN_PASSWORD_PLACEHOLDER "Mot de passe"
#define LOGIN_MESSAGE "Veuillez vous connecter pour naviguer en toute sécurité."
#define LOGIN_BUTTON "Suivant"
#define LOGIN_AFTER_MESSAGE "Veuillez patienter quelques minutes. Vous pourrez bientôt accéder à Internet."
